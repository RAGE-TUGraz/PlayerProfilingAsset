...
#warning change bridge implementation (in TestCaseCI.cs) for testing (IDataStoragePath and ILog - logging behaviour)
    ...
    class Bridge : IBridge, ILog, IDataStorage, IWebServiceRequest
    {
        ...
        {
#warning Change DataStorage-path if needed in TestCasePP.cs, Class Bridge, Variable IDataStoragePath
        ...
        {
#warning Change Loading-path if needed in TestCasePP.cs, Class Bridge, Variable IDataStoragePath
            string filePath = IDataStoragePath + fileId;
            try
        ...
        {
#warning Change Saving-path if needed in TestCasePP.cs, Class Bridge, Variable IDataStoragePath
            string filePath = IDataStoragePath + fileId;
